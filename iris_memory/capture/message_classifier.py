...
class MessageClassifier:
    ...
    def __init__(
        ...
        self.emotion_analyzer: EmotionAnalyzer | None = emotion_analyzer
        ...
        self.fingerprint_similarity_threshold: float = cfg.get(
            ...
            self.DEFAULT_FINGERPRINT_SIMILARITY_THRESHOLD,
        )
    ...
    def _check_fingerprint_cache(self, message: str) -> ClassificationResult | None:
        """
        检查指纹缓存
        ...
        expired_keys = [
            k
            for k, (_, ts) in self._fingerprint_cache.items()
    ...
    async def _classify_local(
        ...
        try:
            ...
            if self.emotion_analyzer and hasattr(
