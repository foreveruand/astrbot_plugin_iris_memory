...
class LLMConflictResolver(LLMEnhancedDetector[ConflictDetectionResult]):
    ...
    def _rule_detect(
        self, memory1: Memory, memory2: Memory, context: dict[str, Any] | None = None
    ...
    def _build_prompt(self, memory1: Memory, memory2: Memory, **kwargs) -> str:
        """构建LLM提示词"""
    ...
    def _might_have_subtle_conflict(self, text1: str, text2: str) -> bool:
        ...
        for word1, word2 in _SUBTLE_CONFLICT_INDICATORS:
            if (word1 in text1 and word2 in text2) or (
                word1 in text2 and word2 in text1
            ):
                return True
