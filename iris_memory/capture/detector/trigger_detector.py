...
from iris_memory.core.types import TriggerMatch, TriggerType
...
class TriggerDetector:
    ...
    def _calculate_confidence(
        self, text: str, pattern: str, trigger_type: TriggerType
    ) -> float:
        """计算触发器置信度
    ...
    def get_highest_confidence_trigger(self, text: str) -> TriggerMatch | None:
        """获取置信度最高的触发器
